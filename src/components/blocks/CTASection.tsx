    ...
    <section className="max-w-7xl mx-auto px-6 py-16">
      <div className="bg-blue-600 rounded-3xl p-12 text-center text-white">
        ...
        <p className="text-blue-100 mb-8 max-w-xl mx-auto">
          Pasang sekarang dan jangkau ribuan calon pembeli di Bengkulu. Gratis
          dan mudah!
        </p>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <button
            ...
            className="bg-white/10 hover:bg-white/20 text-white font-bold py-3 px-8 rounded-xl transition border border-white/20"
          >
            Cari Motor Sekarang
          </button>
        </div>
